...
namespace project_tryal
{
    public partial class viewscoreboard : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select sporteventtable.sportid, sporteventtable.sportname, sporteventtable.max_players from sporteventtable JOIN tournament_sport_table ON sporteventtable.sportid=tournament_sport_table.sid where tid=@tid", con);
