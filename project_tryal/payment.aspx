<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="project_tryal.payment" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <asp:View ID="report" runat="server">
                <div class="receipt">
                    ...
                    <hr />
                    <p><strong>Student Name:</strong> <asp:Label ID="lblStudentName" runat="server" Text=""></asp:Label></p>
                    <p><strong>Student ID:</strong> <asp:Label ID="lblStudentID" runat="server" Text=""></asp:Label></p>
                    <p><strong>Product:</strong> <asp:Label ID="lblProduct" runat="server" Text=""></asp:Label></p>
                    <p><strong>Amount Paid:</strong> ₹<asp:Label ID="lblAmount" runat="server" Text=""></asp:Label></p>
                    <p><strong>Date:</strong> <asp:Label ID="lblDate" runat="server" Text=""></asp:Label></p>
                    <hr />
