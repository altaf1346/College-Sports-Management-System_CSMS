<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewscoreboard.aspx.cs" Inherits="project_tryal.viewscoreboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid bg-secondary">
            ...
            <div class="card-group-vertical">
                ...
                <br />
                <asp:GridView ID="GridView1" class="mx-auto text-center text-white" runat="server" Width="100%"></asp:GridView>
                <asp:GridView ID="GridView2" class="mx-auto text-center text-white" runat="server" Width="100%"></asp:GridView>
                <br />
            </div>
        </div>
    </form>
