<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addscoreboard.aspx.cs" Inherits="project_tryal.addscoreboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid bg-secondary">
            ...
            <div class="card-group-vertical">
                ...
                <br />
                <asp:Button ID="Button2" class="btn btn-block btn-primary" runat="server" Text="FINISH" OnClick="Button1_Click" />
        </div>
    </form>
</body>
</html>