<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsportteam.aspx.cs" Inherits="project_tryal.addsportteam" %>
    ...
    <form id="form1" runat="server">
        <div class="container shadow mb-2 bg-transparent">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                     <asp:Button ID="Button3" runat="server" class="btn btn-outline-success float-sm-right " Text="PaidList" CausesValidation="False" OnClick="Button3_Click" />
