...
namespace project_tryal
{
    public partial class addscoreboard : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select sporteventtable.sportid, sporteventtable.sportname, sporteventtable.max_players from sporteventtable JOIN tournament_sport_table ON sporteventtable.sportid=tournament_sport_table.sid where tournament_sport_table.tid=@tid", con);
        ...
        protected void DDL2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                // Handle the case where no result is returned or the result is not an integer
            }
        }
