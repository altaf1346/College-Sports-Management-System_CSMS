<%@ Page Language="C#" AutoEventWireup="true" Codefile="admin_dashboard.aspx.cs" Inherits="project_tryal.admin_dashboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container shadow mb-2 bg-transparent">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <asp:Button ID="StudentsList" class="btn btn-outline-success float-sm-right " runat="server" Text="StudentList" OnClick="StudentsList_Click"  />
                     <asp:Button ID="logout" class="btn btn-outline-success float-sm-right " runat="server" Text="" OnClick="logout_Click" />
               <asp:Button ID="RegesteredStudents" class="btn btn-outline-success float-sm-right " runat="server" Text="RegesteredStudent" OnClick="RegesteredStudents_Click"  />
        ...
        <footer id="footer" class="container-fluid " style="height: 5%;">
            ...
            <p class="text-center bg-transparent text-white">&copy; SPORT MANAGEMENT SYSTEM. Design:  Altaf & Faiz.</p>
