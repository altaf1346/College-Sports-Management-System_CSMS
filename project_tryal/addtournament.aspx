<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addtournament.aspx.cs" Inherits="project_tryal.addtournament" %>
                    ...
                    <div class="card-group-vertical">
                        ...
                        <div class="row row-centered card-body">
                            <div class="col col-centered bg-dark text-center text-white">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ValidationExpression="^\d{4}-\d{2}-\d{2}$" ErrorMessage="Invalid date format. Use yyyy-MM-dd." ControlToValidate="TextBox3"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="col col-centered bg-dark text-center text-white">
                                <div class="card-body">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationExpression="^\d{4}-\d{2}-\d{2}$" ErrorMessage="Invalid date format. Use yyyy-MM-dd." ControlToValidate="TextBox4"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                        </div>
                        <br />
                    ...
                    <asp:View ID="tile2" runat="server">
                        <div class="row text-white text-center bg-dark">
                            <div class="card-body">
                                ...
                                <asp:TextBox ID="DATESTART" placeholder="yyyy-MM-dd" runat="server"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^\d{4}-\d{2}-\d{2}$" ErrorMessage="Invalid date format. Use yyyy-MM-dd." ControlToValidate="DATESTART"></asp:RegularExpressionValidator>
                                <br />
                            </div>
                            <div class="card-body">
                                <asp:Label ID="label" runat="server" Text="END DATE" Height="10" Width="200"></asp:Label>
                                <asp:TextBox ID="ENDDATE" placeholder="yyyy-MM-dd" runat="server"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationExpression="^\d{4}-\d{2}-\d{2}$" ErrorMessage="Invalid date format. Use yyyy-MM-dd." ControlToValidate="ENDDATE"></asp:RegularExpressionValidator>
                                <br />
                            </div>
                        </div>
                        <div class="card text-white text-center bg-dark">
