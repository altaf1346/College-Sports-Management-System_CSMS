<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsportevent.aspx.cs" Inherits="project_tryal.addsportevent" %>
    ...
    <form id="form1" runat="server">
        <div class="container shadow mb-2 bg-transparent">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                     <asp:Button ID="Button3" runat="server" class="btn btn-outline-success float-sm-right " Text="RegisterdSportList" CausesValidation="False" OnClick="Button3_Click1" />
